...
@app.post("/startprocessinput_service/startprocessinput")
def process_startprocessinput(data: StartprocessInput):
    ...
    for file_path in python_files:
        function_to_call = dynamic_import_function(str(file_path), "StartprocessInput")
        if function_to_call:
            print(f"✅ Function StartprocessInput found in: {file_path}")
