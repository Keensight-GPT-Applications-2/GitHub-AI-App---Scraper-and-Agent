...
@app.post("/preprocess_textinput_service/preprocess_textinput")
def process_preprocess_textinput(data: Preprocess_textInput):
    ...
    for file_path in python_files:
        function_to_call = dynamic_import_function(str(file_path), "Preprocess_textInput")
        if function_to_call:
            print(f"✅ Function Preprocess_textInput found in: {file_path}")
