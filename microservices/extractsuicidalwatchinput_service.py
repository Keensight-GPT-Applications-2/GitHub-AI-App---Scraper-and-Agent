...
@app.post("/extractsuicidalwatchinput_service/extractsuicidalwatchinput")
def process_extractsuicidalwatchinput(data: ExtractsuicidalwatchInput):
    ...
    for file_path in python_files:
        function_to_call = dynamic_import_function(str(file_path), "ExtractsuicidalwatchInput")
        if function_to_call:
            print(f"✅ Function ExtractsuicidalwatchInput found in: {file_path}")
