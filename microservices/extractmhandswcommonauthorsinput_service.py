...
@app.post("/extractmhandswcommonauthorsinput_service/extractmhandswcommonauthorsinput")
def process_extractmhandswcommonauthorsinput(data: ExtractmhandswcommonauthorsInput):
    ...
    for file_path in python_files:
        function_to_call = dynamic_import_function(str(file_path), "ExtractmhandswcommonauthorsInput")
        if function_to_call:
            print(f"✅ Function ExtractmhandswcommonauthorsInput found in: {file_path}")
