...
@app.post("/adminhomeinput_service/adminhomeinput")
def process_adminhomeinput(data: AdminhomeInput):
    ...
    for file_path in python_files:
        function_to_call = dynamic_import_function(str(file_path), "AdminhomeInput")
        if function_to_call:
            print(f"✅ Function AdminhomeInput found in: {file_path}")
