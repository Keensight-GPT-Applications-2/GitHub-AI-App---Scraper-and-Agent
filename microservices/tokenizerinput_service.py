...
@app.post("/tokenizerinput_service/tokenizerinput")
def process_tokenizerinput(data: TokenizerInput):
    ...
    for file_path in python_files:
        function_to_call = dynamic_import_function(str(file_path), "TokenizerInput")
        if function_to_call:
            print(f"✅ Function TokenizerInput found in: {file_path}")
