...
@app.post("/admincnnmodelinput_service/admincnnmodelinput")
def process_admincnnmodelinput(data: AdmincnnmodelInput):
    ...
    for file_path in python_files:
        function_to_call = dynamic_import_function(str(file_path), "AdmincnnmodelInput")
        if function_to_call:
            print(f"✅ Function AdmincnnmodelInput found in: {file_path}")
