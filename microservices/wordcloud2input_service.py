...
@app.post("/wordcloud2input_service/wordcloud2input")
def process_wordcloud2input(data: Wordcloud2Input):
    ...
    for file_path in python_files:
        function_to_call = dynamic_import_function(str(file_path), "Wordcloud2Input")
        if function_to_call:
            print(f"✅ Function Wordcloud2Input found in: {file_path}")
