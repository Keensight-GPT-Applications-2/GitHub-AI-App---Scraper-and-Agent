...
@app.post("/detecttypesinput_service/detecttypesinput")
def process_detecttypesinput(data: DetecttypesInput):
    ...
    for file_path in python_files:
        function_to_call = dynamic_import_function(str(file_path), "DetecttypesInput")
        if function_to_call:
            print(f"✅ Function DetecttypesInput found in: {file_path}")
