...
@app.post("/alluserresultsinput_service/alluserresultsinput")
def process_alluserresultsinput(data: AlluserresultsInput):
    ...
    for file_path in python_files:
        function_to_call = dynamic_import_function(str(file_path), "AlluserresultsInput")
        if function_to_call:
            print(f"✅ Function AlluserresultsInput found in: {file_path}")
