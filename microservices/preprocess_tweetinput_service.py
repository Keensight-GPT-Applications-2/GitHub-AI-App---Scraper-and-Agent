...
@app.post("/preprocess_tweetinput_service/preprocess_tweetinput")
def process_preprocess_tweetinput(data: Preprocess_tweetInput):
    ...
    for file_path in python_files:
        function_to_call = dynamic_import_function(str(file_path), "Preprocess_tweetInput")
        if function_to_call:
            print(f"✅ Function Preprocess_tweetInput found in: {file_path}")
