...
@app.post("/wordcloudinput_service/wordcloudinput")
def process_wordcloudinput(data: WordcloudInput):
    ...
    for file_path in python_files:
        function_to_call = dynamic_import_function(str(file_path), "WordcloudInput")
        if function_to_call:
            print(f"✅ Function WordcloudInput found in: {file_path}")
